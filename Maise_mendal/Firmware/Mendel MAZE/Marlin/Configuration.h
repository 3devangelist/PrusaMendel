...
///////////// in the wiki OF MKS GEN says that is compatible with ramps 1.4 (3Denvangelist)
#ifndef MOTHERBOARD
...
#define CUSTOM_MACHINE_NAME "Mendel maZE"

// Added for BQ (BASE CODE)
//#define SOURCE_CODE_URL "http://www.bq.com/gb/downloads-prusa-i3-hephestos.html"

///////////// Added By 3D Envangelist
#define SOURCE_CODE_URL "https://github.com/3devangelist/PrusaMendel"
...
#define TEMP_HYSTERESIS 8       // (degC) range of +/- temperatures considered "close" to the target one
#define TEMP_WINDOW     0,5       // (degC) Window around target to start the residency timer x degC early.

// Bed temperature must be close to target for this long before M190 returns success
#define TEMP_BED_RESIDENCY_TIME 0   // (seconds)
#define TEMP_BED_HYSTERESIS 8       // (degC) range of +/- temperatures considered "close" to the target one
#define TEMP_BED_WINDOW     0,5       // (degC) Window around target to start the residency timer x degC early.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 396.3, 93}
